...
1. **Heatmaps** - Click maps, scroll depth, attention areas, rage clicks. **Important caveat:** Heatmap screenshots cover the last 30 days, but site conditions may have changed during that window (e.g., a sitewide promo running for only 1 of the 4 weeks). This can skew click patterns and scroll depth. If you spot an interesting finding in heatmaps, ask the user a followup question to confirm whether the data is representative before building a test around it. If nothing stands out, keep the heatmap section brief and don't over-emphasize it.
